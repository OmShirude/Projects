# -*- coding: utf-8 -*-
"""bird-species-prediction-using-cnn.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1s6gpgiQzts_UN9kBmjOAxj5LxKHP-rum
...
plt.show()While compiling the model we need to set the type of loss which will be Categorical Crossentropy for our model alongwith this we also need to set the optimizer and the metrics respectively.
"""
